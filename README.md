...
| Package | Research / engineering focus |
| :-- | :-- |
| [**context-dedup**](https://github.com/edujbarrios/context-dedup)<br>[![context-dedup downloads](https://api.pepy.tech/badge/context-dedup)](https://pepy.tech/project/context-dedup) | Context deduplication for reducing redundant content in LLM and agent workflows. |
| [**evidenceflow**](https://github.com/edujbarrios/evidenceflow)<br>[![evidenceflow downloads](https://api.pepy.tech/badge/evidenceflow)](https://pepy.tech/project/evidenceflow) | Deterministic analysis of how retrieved and tool-generated evidence propagates through AI-agent traces. |
| [**rag-chunk-audit**](https://pypi.org/project/rag-chunk-audit/)<br>[![rag-chunk-audit downloads](https://api.pepy.tech/badge/rag-chunk-audit)](https://pepy.tech/project/rag-chunk-audit) | RAG chunk-quality auditing for segmentation and retrieval analysis. |

### Evaluation, Regression & Safety

| Package | Research / engineering focus |
| :-- | :-- |
| [**embedding-drift-lite**](https://pypi.org/project/embedding-drift-lite/)<br>[![embedding-drift-lite downloads](https://api.pepy.tech/badge/embedding-drift-lite)](https://pepy.tech/project/embedding-drift-lite) | Embedding-distribution drift detection and diagnostic inspection. |
| [**parametricbench**](https://pypi.org/project/parametricbench/)<br>[![parametricbench downloads](https://api.pepy.tech/badge/parametricbench)](https://pepy.tech/project/parametricbench) | Provider-independent regression benchmarking for LLM and VLM systems. |
| [**promptshield-llm**](https://pypi.org/project/promptshield-llm/)<br>[![promptshield-llm downloads](https://api.pepy.tech/badge/promptshield-llm)](https://pepy.tech/project/promptshield-llm) | Prompt-injection, unsafe-instruction, and input-risk screening for LLM pipelines. |

### Multimodal & VLM Analysis

| Package | Research / engineering focus |
| :-- | :-- |
| [**metaclean-vlm**](https://pypi.org/project/metaclean-vlm/)<br>[![metaclean-vlm downloads](https://api.pepy.tech/badge/metaclean-vlm)](https://pepy.tech/project/metaclean-vlm) | Metadata normalization for image and vision-language model datasets. |
| [**visual-patch-audit**](https://pypi.org/project/visual-patch-audit/)<br>[![visual-patch-audit downloads](https://api.pepy.tech/badge/visual-patch-audit)](https://pepy.tech/project/visual-patch-audit) | Image-patch auditing and visual-signal inspection for VLM workflows. |
| [**vlm-occlusion**](https://pypi.org/project/vlm-occlusion/)<br>[![vlm-occlusion downloads](https://api.pepy.tech/badge/vlm-occlusion)](https://pepy.tech/project/vlm-occlusion) | Grid-based black-box occlusion analysis for VLM claim sensitivity. |
| [**vlm-prior-probe**](https://github.com/edujbarrios/vlm-prior-probe)<br>[![vlm-prior-probe downloads](https://api.pepy.tech/badge/vlm-prior-probe)](https://pepy.tech/project/vlm-prior-probe) | Counterfactual black-box evaluation of whether VLMs follow visual evidence or learned priors. |

### Visualization & Developer Experience

| Package | Research / engineering focus |
| :-- | :-- |
| [**matplotlib-dark**](https://github.com/edujbarrios/matplotlib-dark)<br>[![matplotlib-dark downloads](https://api.pepy.tech/badge/matplotlib-dark)](https://pepy.tech/project/matplotlib-dark) | Automatic dark mode for Matplotlib with ready-to-use themes and safe temporary styling. |

### Generative Audio

| Package | Research / engineering focus |
| :-- | :-- |
| [**text-to-music-prompt-structurer**](https://pypi.org/project/text-to-music-prompt-structurer/)<br>[![text-to-music-prompt-structurer downloads](https://api.pepy.tech/badge/text-to-music-prompt-structurer)](https://pepy.tech/project/text-to-music-prompt-structurer) | Structured prompt extraction for text-to-music generation workflows. |
